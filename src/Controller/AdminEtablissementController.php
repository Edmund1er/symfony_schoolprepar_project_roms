...
final class AdminEtablissementController extends AbstractController
{
    ...
    {
        return $this->render('admin_etablissement/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_etablissement/new.html.twig', [
    ...
    {
        return $this->render('admin_etablissement/show.html.twig', [
            'etablissement' => $etablissement,
        ]);
    }
    ...
    public function edit(Request $request, Etablissement $etablissement, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_etablissement/edit.html.twig', [
            'etablissement' => $etablissement,
            'form' => $form,
        ]);
    }
