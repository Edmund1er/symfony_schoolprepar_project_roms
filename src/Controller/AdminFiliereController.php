...
final class AdminFiliereController extends AbstractController
{
    ...
    {
        return $this->render('admin_filiere/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_filiere/new.html.twig', [
            'filiere' => $filiere,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin_filiere/show.html.twig', [
            'filiere' => $filiere,
        ]);
    }
    ...
    public function edit(Request $request, Filiere $filiere, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_filiere/edit.html.twig', [
            'filiere' => $filiere,
            'form' => $form,
        ]);
    }
